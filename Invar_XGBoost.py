...
# scores = cross_val_score(XGBRegressor(objective='reg:squarederror'), train_features, train_labels, 
#                          scoring='neg_mean_squared_error')
regr=XGBRegressor(learning_rate=0.1,random_state=0)
...
plt.savefig('Figures/01_24_XGBRegressor.png', format='png', dpi=300)
